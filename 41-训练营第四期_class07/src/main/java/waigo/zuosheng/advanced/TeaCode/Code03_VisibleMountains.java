...
public class Code03_VisibleMountains {
	...
	public static void main(String[] args) {
		...
		for (int i = 0; i < testTimes; i++) {
			...
			if (getVisibleNum(arr) != waigo.zuosheng.advanced.MyCode.Code03_VisibleMountains.getVisibleNum(arr)) {
				printArray(arr);
				System.out.println(waigo.zuosheng.advanced.MyCode.Code03_VisibleMountains.getVisibleNum(arr));
